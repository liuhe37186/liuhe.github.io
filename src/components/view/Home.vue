...
export default {
  ...
  methods:{
    getHomeData(){
      console.log("getHomeData-enter",process.env.VUE_APP_BASEURL)
      console.log("getHomeData$post:",this.$post)
      this.$get("index_data/1.html").then(res =>{
        console.log("res:",res);
      },error=>{
